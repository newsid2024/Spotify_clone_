...
var SpotifyWebPlayer = /** @class */ (function (_super) {
    ...
    function SpotifyWebPlayer(props) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, seek(token, Math.round(track.durationMs * percentage))];
                    case 2:
                        _a.sent();
                        this.updateState({
                            position: position,
        ...
        _this.handleFavoriteStatusChange = function (isSaved) {
            ...
            callback(__assign(__assign({}, __assign(__assign({}, _this.state), { isSaved: isSaved })), { type: TYPE.TRACK }));
        };
    ...
    SpotifyWebPlayer.prototype.render = function () {
        ...
        if (isReady) {
            /* istanbul ignore else */
            if (!info) {
                info = (React.createElement(Info, { handleFavoriteStatusChange: this.handleFavoriteStatusChange, showSaveIcon: showSaveIcon, isActive: isActive, styles: this.styles, token: token, track: track, updateSavedStatus: updateSavedStatus }));
            }
            output = (React.createElement(React.Fragment, null,
                ...
                React.createElement(Actions, { currentDeviceId: currentDeviceId, devices: devices, isDevicesOpen: isUnsupported && !deviceId, onClickDevice: this.handleClickDevice, setVolume: this.setVolume, styles: this.styles, volume: volume })));
        }
        ...
        return (React.createElement(Player, { styles: this.styles },
